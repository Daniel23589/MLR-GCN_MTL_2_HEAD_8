...
def main():
    ...
    # Ahora desempaquetamos todos los valores que devuelve validate
    p_c, r_c, f_c, j_c, p_o, r_o, f_o, j_o, mAP_score, dish_acc = validate(test_loader, model, args)

    # Mostrar todas las métricas importantes
    print('Test: [{}/{}]\t '
          'P_C {:.2f} \t R_C {:.2f} \t F_C {:.2f} \t J_C {:.2f} \t'
          'P_O {:.2f} \t R_O {:.2f} \t F_O {:.2f} \t J_O {:.2f} \t'
          'mAP {:.2f} \t DishAcc {:.2f}'
